Feature: Dependency resolution
  ...
  Scenario: launch a environment with dependencies inside the same environment
  ...
  Scenario: delete a environment with dependencies inside the same environment
